  ...
  return (
      <MaxWidthWrapper className="py-8">
        <DragCloseDrawer open={emailSent} setOpen={setEmailSent}>
          <h2 className="font-Integral text-4xl lg:text-7xl text-black text-wrap max-w-5xl mx-auto text-center">Email enviado com sucesso</h2>
          <p className='text-black text-base text-center mt-8'>Em breve entraremos em contato.</p>
        </DragCloseDrawer>
